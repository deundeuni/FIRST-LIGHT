...
* **상위 체계 연동** — `ARCHITECTURE_STRATEGY v3.2.4` 범용 생존 아키텍처, `chiplet-apu-multi-system-survival-architecture v2.6` (Tri-State Isolation), 및 `LAST-LIGHT` 비상 피난 유도 시스템과 연계된 최상위 신뢰도 평가 레이어로 작동.
