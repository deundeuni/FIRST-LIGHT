...
* v1.1 Final (2026-09-26): 3장 B.2 칩렛 건전성 지수 기호를 H에서 H_polar로 개명하여 H-INDICATOR 백서의 H_indicator/H_ocean 기호 체계와의 충돌 방지, FIRST-LIGHT 모체 DOI(10.5281/zenodo.22683225) 확정 반영 및 8장 H-INDICATOR 상위 모체 포괄 출처 정립.
* v1.2 Final (2026-09-26): GitHub 마크다운 뷰어에서 수식 5건(단절 역추정 3건, 칩렛 건전성 지수 2건)이 렌더링되지 않고 빈 칸으로 표시되는 문제를 확인, H-INDICATOR 백서의 표기법을 원용하여 3장 B절 수식을 코드블록 ASCII 텍스트로 전환 완료. 7.5절 "검색 가능성 확보 및 글로벌 인덱싱" 섹션 신규 추가.
...
본 백서의 모든 핵심 수식은 H-INDICATOR 백서 정본과 동일한 방식으로, ASCII 텍스트 수식 및 영문 동의어 키워드를 병기하여 검색엔진 및 특허 심사관의 텍스트 인덱싱 누락 리스크를 차단한다.
