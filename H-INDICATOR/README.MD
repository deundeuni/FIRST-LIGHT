...
* Original Authority Notice: The Korean original text (`README.ko.md`) serves as the primary legal and technical authority. This English translation is provided for reference purposes only.
...
* **Upper Architecture Interlinking** — Operates as the highest evaluation layer interlinked with `ARCHITECTURE_STRATEGY v3.2.4` universal survival architecture, `chiplet-apu-multi-system-survival-architecture v2.6` (Tri-State Isolation), and `LAST-LIGHT` / `FIRST-LIGHT` emergency guidance systems.
...
* **Ecosystem Repositories & DOIs**
  ...
  * Disaster Guidance & Auxiliary Infrastructure (`LAST-LIGHT` / `FIRST-LIGHT`) — GitHub: `deundeuni / LAST-LIGHT` | CERN Zenodo DOI: `10.5281/zenodo.22373189`
